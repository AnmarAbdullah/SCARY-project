...
Forest Environment with a cabin and 3 satellite towers, everything is connected via roads/wires on the floor
...
Forest environment with a cabin at the center and 4 relays around.



The players will first have to restore the power by pulling a lever near the cabin, they will be connected by a wire on the floor to guide the players to it. Once they pull the lever. The cabin will lit, and will also contain an audio file, a map, and a note containing a noted story that hints the answers for each relay scattered in the map. Each relay will have 4 levers, with their own names(Amplify, Ground, Suppress, Stabilize). They must be pulled in order, by all 4 players. Once done, the cabin will open up a ground door that will lead to level 3. Speaker lady will also inform about the objective.
